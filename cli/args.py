...
class Arguments:
    def __init__(self, cli: CLI) -> None:
        self.__cli = cli
        self.__parser = argparse.ArgumentParser(prog="edgesight", description="EdgeSight CLI")
        ...
        self.__config.add_argument("-f", "--file", help="specify the configuration file", metavar="FILE", default="edgesight.conf", dest="config_file")
